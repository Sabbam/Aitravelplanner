...
function CreateTrip({createTripPageRef}) {
  ...
  <h3 className="font-extrabold text-3xl md:text-6xl bg-gradient-to-r from-sky-400 via-white to-gray-400 bg-clip-text text-transparent">
    AI Travel Planner
  </h3>
  <p className="mt-2 text-sm md:text-base text-gray-600 dark:text-gray-400 tracking-wide">
    Plan smarter, travel better — your personalized trip assistant powered by AI.
  </p>
</div>
